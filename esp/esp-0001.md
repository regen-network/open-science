...
author: Daniel Swid <daniel@regen.network>
        https://github.com/regen-network/ros/blob/master/esp/000-template.md
created: 2019-07-08
updated: na
---
...
Once the ESP is ready for the repository, the EIP editor will:
...
This document was derived heavily from [Ethereiums's EIP-1]. Please direct all comments to the ESP editors.
