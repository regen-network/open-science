...
pdfPlotFile <- 'KaosNorth2020/ndviThresh_037.pdf'
pdfAvgPlotFile <- 'KaosNorth2020/normalizedThresh_037.pdf'
...
wasGrazed <- function(ndviVec, endOfGrazing) {
  ...
  (ndviVec[nextDateIndex] - ndviVec[prevDateIndex]) < threshold
}
# Read the Shapefile
